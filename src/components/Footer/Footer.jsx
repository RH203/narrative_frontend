export default function Footer() {
  ...
  return (
    <footer className="text-gray-500 bg-white px-4 py-5 w-full mx-auto md:px-8 mt-20 font-poppins">
      <div className="max-w-lg sm:mx-auto sm:text-center">
        <p className="text-indigo-400 font-semibold text-2xl">Narrative</p>

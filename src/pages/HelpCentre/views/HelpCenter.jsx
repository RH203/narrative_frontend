...
export default function HelpCenter() {
  const tabItems = [
    {
      ...
      "
          to={"/help-center/bot-nara"}
        >
          Ask Nara our assistant.
        </Link>
      ),
    },
    {
  ...
  return (
    <div className="w-10/12 mx-auto font-poppins">
      ...
      {/* Help Center start */}
      <Tabs.Root
        className="w-full mx-auto mb-20 px-4 md:px-8"
        defaultValue="Overview"
      >
        <Tabs.List
          className="w-full border-b flex items-center justify-center gap-x-3 lg:mx-0 md:mx-0 sm:mx-32 text-sm"
        ...
        {tabItems.map((item, idx) => (
          <Tabs.Content key={idx} className="py-6" value={item.name}>
            <div className="collapse collapse-plus border border-gray-800 m-5">

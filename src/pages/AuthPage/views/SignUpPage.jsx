  ...
  return (
    <main className="w-full flex">
      ...
      <div className="flex-1 flex items-center justify-center h-screen">
        <div className="w-4/5 space-y-8 bg-white text-gray-600 sm:px-0 rounded-xl shadow-md p-5">
          <div className="px-5">
            <img
          ...
          <div className="grid grid-cols-3 gap-x-3 px-5">
            <button className="flex items-center justify-center py-2.5 border rounded-lg hover:border-gray-800 transition duration-300 active:bg-gray-100">
              <svg
                className="w-5 h-5"
                viewBox="0 0 48 48"
                fill="none"
          ...
          <form onSubmit={(e) => e.preventDefault()} className="space-y-5 mx-5">
            <div>
